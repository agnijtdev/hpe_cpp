...
rows = [
    ...
    f"{ts},ospf_area_healing_r3_r4,hpe-r3_eth0,{old_nh},{routeget_ms},{kernel_ms},{bird_ms},{tx},{rx},{lost},{loss_percent},\"{routeget_line}\",\"{kernel_line}\",\"{bird_line}\",\"{missing_text}\""
]
