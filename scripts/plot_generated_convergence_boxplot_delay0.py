...
summary_csv = out_dir / "generated_convergence_boxplot_summary_delay0.csv"
...
plt.title("Generated-prefix BGP Convergence — 10,000 Prefixes, Bulk Injection")
plt.grid(axis="y", alpha=0.45)

plt.tight_layout()

png_path = out_dir / "generated_convergence_10000_delay0_boxplot.png"
pdf_path = out_dir / "generated_convergence_10000_delay0_boxplot.pdf"
